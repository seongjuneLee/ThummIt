...
//    termsOfUsesButton.alpha = 0.5;
    [termsOfUsesButton addTarget:self action:@selector(buttonTouched:) forControlEvents:UIControlEventTouchUpInside];
...
//    privacyPolicyButton.alpha = 0.5;
    [privacyPolicyButton addTarget:self action:@selector(buttonTouched:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [attributedText addAttributes:@{ NSUnderlineStyleAttributeName : @(NSUnderlineStyleSingle), NSForegroundColorAttributeName : [UIColor blackColor]} range:termsOfUsesRange];
    [attributedText addAttributes:@{ NSUnderlineStyleAttributeName : @(NSUnderlineStyleSingle), NSForegroundColorAttributeName : [UIColor blackColor]} range:privacyPolicyRange];
...
-(void)buttonTouched:(id)sender{
    ...
    NSLog(@"buttonTappedbuttonTappedbuttonTappedbuttonTappedbuttonTapped");
}
